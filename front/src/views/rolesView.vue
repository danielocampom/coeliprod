    ...
    methods: {
        ...
        async addRoll(){
            ...
            if(data.status == 200){
                ...
                this.openNotification(`Error: inesperado al registrar el Roll`, `Si el problema persiste, comunicate con el administrador`, 'danger', 'top-left',`<box-icon name='bug' color="#fff"></box-icon>`)
